...
export const DRUM_KITS: DrumKitPreset[] = [
  {
    ...
    voices: [
      ...
      { name: 'Ride Bow Accent', kind: 'ride', decaySeconds: 1.75, recordedFile: 'ride_vl4_rr3.flac', recordedBank: 'core' },
      ...
      { name: 'Splash', kind: 'crash', decaySeconds: 1.45, recordedFile: 'splash_vl3_rr1.flac', recordedBank: 'cymbals' },

...
export const DRUM_KITS: DrumKitPreset[] = [
  {
    ...
    name: 'Acoustic Drums',
    voices: [
      // Virtuosity Drums CC0 recorded performance kit — every sound in this
      // layout is a recorded acoustic hit, ordered as a playable 32-pad kit:
      // feet/snare, hats, toms, ride, crashes, then articulation variants.
      { name: 'Kick Soft', kind: 'kick', decaySeconds: .7, recordedFile: 'kick_vl2_rr1.flac', recordedBank: 'core' },
      { name: 'Kick', kind: 'kick', decaySeconds: .7, recordedFile: 'kick_vl4_rr1.flac', recordedBank: 'core' },
      { name: 'Kick Alt', kind: 'kick', decaySeconds: .7, recordedFile: 'kick_vl4_rr3.flac', recordedBank: 'core' },
      { name: 'Snare Ghost', kind: 'snare', decaySeconds: .42, recordedFile: 'snare_vl1_rr1.flac', recordedBank: 'core' },
      { name: 'Snare Center', kind: 'snare', decaySeconds: .48, recordedFile: 'snare_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Snare Crack', kind: 'snare', decaySeconds: .52, recordedFile: 'snare_vl5_rr1.flac', recordedBank: 'core' },
      { name: 'Snare Alt', kind: 'snare', decaySeconds: .48, recordedFile: 'snare_vl4_rr2.flac', recordedBank: 'core' },
      { name: 'Side Stick', kind: 'rim', decaySeconds: .14, recordedFile: 'sidestick_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Side Stick Soft', kind: 'rim', decaySeconds: .14, recordedFile: 'sidestick_vl1_rr2.flac', recordedBank: 'core' },
      { name: 'Closed Hat Soft', kind: 'hihat', decaySeconds: .16, recordedFile: 'hhc_vl1_rr1.flac', recordedBank: 'core' },
      { name: 'Closed Hat', kind: 'hihat', decaySeconds: .17, recordedFile: 'hhc_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Closed Hat Accent', kind: 'hihat', decaySeconds: .18, recordedFile: 'hhc_vl4_rr3.flac', recordedBank: 'core' },
      { name: 'Pedal Hat', kind: 'hihat', decaySeconds: .28, recordedFile: 'hhp_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Open Hat Light', kind: 'hihat', decaySeconds: .65, recordedFile: 'hho_vl2_rr1.flac', recordedBank: 'core' },
      { name: 'Open Hat', kind: 'hihat', decaySeconds: .9, recordedFile: 'hho_vl4_rr1.flac', recordedBank: 'core' },
      { name: 'High Tom Soft', kind: 'tom', decaySeconds: .5, recordedFile: 'tomhi_vl3_rr2.flac', recordedBank: 'core' },
      { name: 'High Tom', kind: 'tom', decaySeconds: .62, recordedFile: 'tomhi_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'High Tom Accent', kind: 'tom', decaySeconds: .66, recordedFile: 'tomhi_vl3_rr3.flac', recordedBank: 'core' },
      { name: 'Floor Tom Soft', kind: 'tom', decaySeconds: .7, recordedFile: 'tomlo_vl3_rr2.flac', recordedBank: 'core' },
      { name: 'Floor Tom', kind: 'tom', decaySeconds: .84, recordedFile: 'tomlo_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Floor Tom Accent', kind: 'tom', decaySeconds: .9, recordedFile: 'tomlo_vl3_rr3.flac', recordedBank: 'core' },
      { name: 'Ride Bow Soft', kind: 'ride', decaySeconds: 1.35, recordedFile: 'ride_vl1_rr1.flac', recordedBank: 'core' },
      { name: 'Ride Bow', kind: 'ride', decaySeconds: 1.65, recordedFile: 'ride_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Ride Bow Accent', kind: 'ride', decaySeconds: 1.75, recordedFile: 'ride_vl3_rr3.flac', recordedBank: 'core' },
      { name: 'Ride Bell', kind: 'ride', decaySeconds: 1.7, recordedFile: 'ridebell_vl3_rr1.flac', recordedBank: 'core' },
      { name: 'Ride Bell Accent', kind: 'ride', decaySeconds: 1.85, recordedFile: 'ridebell_vl3_rr3.flac', recordedBank: 'core' },
      { name: 'Crash Light', kind: 'crash', decaySeconds: 2.2, recordedFile: 'crash_vl2_rr1.flac', recordedBank: 'cymbals' },
      { name: 'Crash', kind: 'crash', decaySeconds: 3, recordedFile: 'crash_vl3_rr2.flac', recordedBank: 'cymbals' },
      { name: 'Crash Alt', kind: 'crash', decaySeconds: 3, recordedFile: 'crash_vl3_rr3.flac', recordedBank: 'cymbals' },
      { name: 'Splash', kind: 'crash', decaySeconds: 1.45, recordedFile: 'splash_vl1_rr1.flac', recordedBank: 'cymbals' },
      { name: 'China', kind: 'china', decaySeconds: 2.8, recordedFile: 'china_vl3_rr1.flac', recordedBank: 'cymbals' },
      { name: 'China Accent', kind: 'china', decaySeconds: 3, recordedFile: 'china_vl5_rr2.flac', recordedBank: 'cymbals' },
    ],
  },
  {
    id: 'cymbals-metal',
    ...
    voices: [
      ...
      { name: 'Splash', kind: 'crash', decaySeconds: 1.4, recordedFile: 'splash_vl1_rr1.flac', recordedBank: 'cymbals' },

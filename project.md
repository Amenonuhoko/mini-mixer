...
- **Make a beat** is visible on Pads (phone) and Sequencer: choose one of 18 styles, Simple / Balanced / Complex, 1 / 2 / 4 bars, and the included parts. Generate & play auditions the current section; New variation keeps its sounds, key and tempo. Keeping current instruments and key is on by default. Each pattern remembers its own generator settings.

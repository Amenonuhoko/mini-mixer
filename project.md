...
- **Transport dock** (bottom, just above the tab bar; `TransportDock`): **metronome** and **master volume** (its slider pops up) on Play's left shoulder, **stop all** on its right. In a landscape phone it sits beside the tabs.
